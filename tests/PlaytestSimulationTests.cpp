...
int main() {
    { PlaytestState s{}; PlaytestInput i{}; i.moveForward=true; PlaytestSimulation::Step(s,i,1.0F/60.0F); if(s.player.x<=0) return Fail("forward"); }
    ...
    { PlaytestState s{}; PlaytestInput i{}; i.fire=true; PlaytestSimulation::Step(s,i,1.0F/60.0F); if(s.weapon.ammoInMag!=29||s.weapon.shotsFired!=1) return Fail("fire"); }
